          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              <div>
                ...
                <p className="text-foreground/70">Rutgers University</p>
                <p className="text-secondary">BS in Computer Science & Mathematics</p>
              ...
              <div>
                ...
                <ul className="text-foreground/70 space-y-1">
                  <li>• AI & DS Collaboratory Ambassador</li>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Python', 'C++', 'Java', 'C', 'MATLAB', 'TypeScript', 'Bash'].map((skill) => (
                      <span
                        key={skill}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['PyTorch', 'TensorFlow', 'NumPy', 'Pandas', 'OpenCV', 'Metal', 'React', 'Next.js'].map((skill) => (
                      <span
                        key={skill}
                        className="px-3 py-1 bg-border text-foreground rounded-full text-sm font-medium"
                      >
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Deep Learning', 'Neural Networks', 'GPU Programming', 'Machine Learning', 'AI Research', 'Computer Vision'].map((skill) => (
                      <span
                        key={skill}
